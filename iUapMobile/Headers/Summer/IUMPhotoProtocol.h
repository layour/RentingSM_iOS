...
// Notifications
#define IUMPHOTO_LOADING_DID_END_NOTIFICATION @"IUMPHOTO_LOADING_DID_END_NOTIFICATION"
#define IUMPHOTO_PROGRESS_NOTIFICATION @"IUMPHOTO_PROGRESS_NOTIFICATION"
...
// Otherwise you can use the IUMPhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the IUMPhoto class for an example implementation of this protocol
//
@protocol IUMPhoto <NSObject>
...
// See IUMPhoto object for an example implementation.
// When the underlying UIImage is loaded (or failed to load) you should post the following
// notification:
// [[NSNotificationCenter defaultCenter] postNotificationName:IUMPHOTO_LOADING_DID_END_NOTIFICATION
//                                                     object:self];
